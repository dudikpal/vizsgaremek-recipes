...
public class CreateIngredientCommand {
    ...
    @Size(max = 255)
    @Schema(description = "name of the ingredient", example = "Hagyma")
    private String name;

    @NotNull(message = "ingredient type must be not empty")
    @Schema(description = "quantity type", example = "DKG")
    ...
    @Schema(description = "quantity of the ingredient", example = "30")
